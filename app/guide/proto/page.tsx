...
function page() {
  ...
  <main>
    ...
    <section className="flex flex-col justify-center items-center py-20">
      <Image alt="먹튀타파소개" width={248} height={255} src={proto}></Image>
      ...
      <div className="w-full max-w-[900px] px-5 py-5">
        <p className="w-full text-center break-words leading-6 text-sm font-medium text-description">
          스포츠토토를 즐기시는 분들 중에 프로토 스포츠 토토를 즐기시는 분들이 많습니다.
        </p>
        <p className="w-full text-center break-words leading-6 text-sm font-medium text-description">
          프로토 스포츠토토는 프로토 기록식과 프로토 승부식으로 나누어집니다.
        </p>
        <p className="w-full text-center break-words leading-6 text-sm font-medium text-description">
      ...
      <div className="px-5">
      <Image alt="프로토토토" width={671} height={186} src={protototo}></Image>
      </div>
