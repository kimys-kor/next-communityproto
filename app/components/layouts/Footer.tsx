...
function Footer() {
  return (
    <footer className="max-w-[1300px]  mx-auto relative w-full h-80 mt-5 border-t border-solid border-gray-200">
      <div className="w-full h-full absolute bg-footer bottom-0 flex items-center justify-center">
        <div className="w-full flex justify-between items-center gap-5">
          <div className="w-1/2 px-5 py-5">
            ...
            <p className="mt-2 text-gray-400 text-xs leading-5 break-words">
              The design and all content of this site are protected under
              copyright law
            </p>
            <p className="text-gray-400 text-xs leading-5 break-words">
            ...
            <p className="mt-3 text-gray-400 text-xs break-words">
